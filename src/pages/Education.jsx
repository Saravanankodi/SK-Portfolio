...
import desflyer from './../assets/logo.png'
const internship = [
    {
...
const achivements = [
    {
        driveLink:"https://drive.google.com/file/d/1ujZaWtYvUG7voPWVeOUVsIpBU7S7eFkt/view?usp=drive_link",
        title:"Mount Zion",
        logo: logo
    },
    {
    ...
    {
        driveLink:"https://drive.google.com/file/d/1UCNN7qHQrsEOg64F5jgXc7VplSEmuNwg/view?usp=drive_link",
        title:"NCC-B",
        logo: logo
    },
    {
        driveLink:"https://drive.google.com/file/d/1N7I4WydRsdz-8cPEXWhjcRQNSYmuQQNb/view?usp=drive_link",
        title:"NCC-c",
        logo: logo
    },
]
        ...
        <div className="w-full h-auto m-auto">
            ...
            <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-5 p-5">
                {achivements.map((item,index)=>(
                    <div className={index === item.length -1 ? 'col-span-2 text text-lg flex gap-2.5':'flex gap-2.5 text text-lg'} >
                        <Certifications
                        key={index}
                        link={item.driveLink}
                        title={item.title}
